...
def main():
    ...
    if args.file_to_run:
        cmd_initial = [sys.executable, '-m', f'dpvo.{args.file_to_run}']
    else:
        args.file_to_run = 'evaluate_tartan_andy.py'
        cmd_initial = [sys.executable, os.path.join(project_root, args.file_to_run)]
